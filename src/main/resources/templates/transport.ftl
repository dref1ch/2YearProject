...
<!DOCTYPE html>
<html lang="en">
<h1>Transport <span class="yellow">UI</span></h1>
...
<table class="container">
    ...
    <#list transport as transport>
        <tr>
            ...
            <td>${transport.updatedAt}</td>
            <td>
                <a  class="button1  "href="/ui/v1/transport/delete/${transport.id}"
            ...
            <td>
                <a href="/ui/v1/transport/pageEdit/${transport.id}">Update</a>
            </td>
...
<div class="wrap" >
    <form action="/ui/v1/transport/put">
