...
<!DOCTYPE html>
<html lang="en">
<h1>Goods <span class="yellow">UI</span></h1>
...
<table class="container">
    ...
    <#list goods as goods>
        <tr>
            ...
            <td>${goods.code}</td>
            <td>${goods.price}</td>
            <td>${goods.delivery}</td>
            <td>${goods.createdAt}</td>
            <td>${goods.updatedAt}</td>
            <td>
                <a  class="button1  "href="/ui/v1/goods/delete/${goods.id}"
            ...
            <td>
                <a href="/ui/v1/goods/pageEdit/${goods.id}">Update</a>
            </td>
